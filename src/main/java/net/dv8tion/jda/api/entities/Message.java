 ...
 * as {@link MessageUpdateEvent} and similar.</b>
 *
 ...
 *         The different types can be found in the {@link MessageType} enum.</li>
 * </ol>
 *
 * <p>When a feature is not available it will throw an {@link UnsupportedOperationException}
 ...
 * This interface extends {@link Formattable} and can be used with a {@link Formatter}
...
public interface Message extends ISnowflake, Formattable {
     ...
     *   </tr>
     * </table>
     * You can use the names with {@link Matcher#group(String) Matcher.group(String)}
     * and the index with {@link Matcher#group(int) Matcher.group(int)}.
     *
     * @see #getJumpUrl()
     */
    ...
    /**
     * Suppresses the warning for missing the {@link GatewayIntent#MESSAGE_CONTENT MESSAGE_CONTENT} intent and using one of the dependent getters.
     */
    ...
    /**
     * Provides the {@link OffsetDateTime} defining when this Message was last
     ...
     * {@link IMentionable} entities will be resolved to the format
     ...
     *
     * <p><b>Requires {@link GatewayIntent#MESSAGE_CONTENT GatewayIntent.MESSAGE_CONTENT}</b>
     *
    ...
    /**
     * The raw textual content of this message. Does not resolve {@link IMentionable}
    ...
    /**
     * Creates an immutable List of {@link Invite} codes
     * that are included in this Message.
     * <br>This will use the {@link Pattern} provided
     * under {@link #INVITE_PATTERN} to construct a {@link Matcher} that will
     ...
     * of the {@link ChannelType} specified.
     *
     ...
     *
     * @return True if the {@link ChannelType} which this message was received
    ...
    /**
     * Gets the {@link ChannelType} that this message was received from.
     *
    ...
    /**
     * Indicates if this Message was sent either by a {@link Webhook} or an app,
     * instead of a {@link User User}.
     * <br>Useful if you want to ignore non-users.
     *
     * @return True if this message was sent by a {@link Webhook}.
     */
    boolean isWebhookMessage();

    /**
     * If this message is from an application-owned {@link Webhook} or
     * is a response to an {@link Interaction}, this will return
     ...
     *
     * @return {@link Category} for this message
     */
    @Nullable
    ...
    /**
     * An immutable list of {@link Message.Attachment Attachments} that are attached to this message.
     * <br>Most likely this will only ever be 1 {@link Message.Attachment Attachment} at most.
     *
     * <p><b>Requires {@link GatewayIntent#MESSAGE_CONTENT GatewayIntent.MESSAGE_CONTENT}</b>
     *
     * @return Immutable list of {@link Message.Attachment Attachments}.
     */
    @Nonnull
    @Unmodifiable
    ...
    /**
     * A {@link MessageActivity} that contains its type and party id.
     *
     ...
     * you can use {@link MessageEditRequest#setReplace(boolean) replace(true)} to remove everything else (embeds/attachments/components).
     *
     ...
     * <br>You can use {@link MessageEditBuilder} to create a {@link MessageEditData} instance.
     *
     * <p>The following {@link ErrorResponse ErrorResponses} are possible:
     * <ul>
     *     <li>{@link ErrorResponse#MISSING_ACCESS MISSING_ACCESS}
     ...
     * <br>You can use {@link EmbedBuilder} to create a {@link MessageEmbed} instance.
     *
     * <p>The following {@link ErrorResponse ErrorResponses} are possible:
     * <ul>
     *     <li>{@link ErrorResponse#MISSING_ACCESS MISSING_ACCESS}
     ...
     *         {@link Permission#VIEW_CHANNEL Permission.VIEW_CHANNEL}
     ...
     * <p>The following {@link ErrorResponse ErrorResponses} are possible:
     * <ul>
     *     <li>{@link ErrorResponse#REQUEST_ENTITY_TOO_LARGE REQUEST_ENTITY_TOO_LARGE}
     ...
     *
     * @param  attachments
     *         The new attachments of the message (Can be {@link FileUpload FileUploads} or {@link AttachmentUpdate AttachmentUpdates})
     *
     * @throws UnsupportedOperationException
     *         If this is a system message
     * @throws IllegalStateException
     ...
     *
     *     <li>{@link ErrorResponse#MESSAGE_BLOCKED_BY_AUTOMOD MESSAGE_BLOCKED_BY_AUTOMOD}
     *     <br>If this message was blocked by an {@link AutoModRule}</li>
     *
     *     <li>{@link ErrorResponse#MESSAGE_BLOCKED_BY_HARMFUL_LINK_FILTER MESSAGE_BLOCKED_BY_HARMFUL_LINK_FILTER}
     ...
     *
     *     <li>{@link ErrorResponse#NO_MUTUAL_GUILDS NO_MUTUAL_GUILDS}
     *     <br>If this is a {@link PrivateChannel} and the currently logged in account
     ...
     *     <br>If this message was blocked by the harmful link filter</li>
     *
     *     <li>{@link ErrorResponse#POLL_INVALID_CHANNEL_TYPE POLL_INVALID_CHANNEL_TYPE}
     *     <br>This channel does not allow polls</li>
     *
     *     <li>{@link ErrorResponse#POLL_WITH_UNUSABLE_EMOJI POLL_WITH_UNUSABLE_EMOJI}
     ...
     *
     * <p>Possible {@link ErrorResponse ErrorResponses} from forwarding include:
     * <ul>
     *     <li>{@link ErrorResponse#REFERENCED_MESSSAGE_NOT_FOUND REFERENCED_MESSSAGE_NOT_FOUND}
     *     <br>If the provided reference cannot be resolved to a message</li>
     *     <li>{@link ErrorResponse#FORWARD_CANNOT_HAVE_CONTENT FORWARD_CANNOT_HAVE_CONTENT}
     *     <br>If additional content is sent alongside a forwarded message</li>
     *     <li>{@link ErrorResponse#CANNOT_FORWARD_UNREADABLE_MESSAGE CANNOT_FORWARD_UNREADABLE_MESSAGE}
     *     <br>If the bot is missing the {@link GatewayIntent#MESSAGE_CONTENT MESSAGE_CONTENT} intent</li>
     * </ul>
     *
     * @param  channel
    ...
    /**
     * Returns the {@link JDA} instance related to this Message.
     *
     ...
     *
     *     <li>{@link ErrorResponse#REACTION_BLOCKED REACTION_BLOCKED}
     *     <br>The user has blocked the currently logged in account and the reaction failed</li>
     *
     *     <li>{@link ErrorResponse#TOO_MANY_REACTIONS TOO_MANY_REACTIONS}
     ...
     * <p>The following {@link ErrorResponse ErrorResponses} are possible:
     * <ul>
     *     <li>{@link ErrorResponse#ALREADY_CROSSPOSTED ALREADY_CROSSPOSTED}
     ...
     * {@link Message.MessageFlag#EMBEDS_SUPPRESSED MessageFlag#EMBEDS_SUPPRESSED}
     *
    ...
    /**
     * This specifies the {@link MessageType} of this Message.
     *
    ...
    /**
     * This is sent on the message object when the message is a response to an {@link Interaction} without an existing message.
     *
     ...
     *
     * @return The {@link Message.Interaction Interaction} of this message.
     *
     * @deprecated
     ...
     * available when the message is a response or a followup to an {@link Interaction}.
     *
     ...
     *
     *     <li>{@link ErrorResponse#THREAD_WITH_THIS_MESSAGE_ALREADY_EXISTS}
     *     <br>This message has already been used to create a thread</li>
     *
     *     <li>{@link ErrorResponse#MAX_ACTIVE_THREADS}
     ...
     * @throws IllegalStateException
     *         If the message's channel is not actually a {@link IThreadContainer}.
     * @throws UnsupportedOperationException
     *         If this is a forum channel.
     *         You must use {@link ForumChannel#createForumPost(String, MessageCreateData) createForumPost(...)} instead.
     * @throws InsufficientPermissionException
     *         If the bot does not have {@link Permission#CREATE_PUBLIC_THREADS Permission.CREATE_PUBLIC_THREADS} in this channel
     *
    ...
    enum MentionType {
        /**
         * Represents a mention for a {@link User User}/{@link Member}
         * <br>The first and only group matches the id of the mention.
         */
        USER("<@!?(\\d+)>", "users"),
        /**
         * Represents a mention for a {@link Role}
         * <br>The first and only group matches the id of the mention.
         */
        ROLE("<@&(\\d+)>", "roles"),
        /**
    ...
    /**
     * Represents a {@link Message} file attachment.
     */
    class Attachment implements ISnowflake, AttachedFile {
        ...
        private static final Set<String> VIDEO_EXTENSIONS =
                Set.of("webm", "flv", "vob", "avi", "mov", "wmv", "amv", "mp4", "mpg", "mpeg", "gifv");
    ...
    /**
     * Represents an {@link Interaction} provided with a {@link Message}.
     *

...
public class MessageEmbed implements SerializableData {
    ...
    public enum MessageEmbedFlag {
         ...
         *
         * @param bitfield Non-negative integer representing a bitfield of embed flags
         ...
         *
         * @param flags A non-null collection of embed flags
    ...
    public enum MessageEmbedMediaFlag {
         ...
         *
         * @param bitfield Non-negative integer representing a bitfield of embed media flags
         ...
         * This is the reverse operation of {@link #fromBitField(int)}.
         *
         * @param flags A non-null collection of embed media flags

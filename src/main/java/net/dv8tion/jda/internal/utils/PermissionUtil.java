...
public class PermissionUtil {
    ...
    public static void requireAnyPermission(Member member, Permission... permissions) {
        ...
        String reason = Stream.of(permissions).map(Permission::name).collect(Collectors.joining(" or "));
        throw new InsufficientPermissionException(
                member.getGuild(), permissions[0], "You need the " + reason + " permission to perform this action!");
    }

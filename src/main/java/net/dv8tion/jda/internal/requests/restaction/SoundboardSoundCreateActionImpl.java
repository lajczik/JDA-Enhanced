...
public class SoundboardSoundCreateActionImpl extends AuditableRestActionImpl<SoundboardSound>
        implements SoundboardSoundCreateAction {
    ...
    private String getBase64Sound() throws IOException {
        byte[] data = IOUtil.readFully(file.getData());
    ...
    private String getMime() {
        ...
        Checks.check(
                index > -1,
                "Filename for soundboard sound is missing file extension. Provided: '" + file.getName()
                        + "'. Must be MP3 or OGG.");

...
public class CategoryOrderActionImpl extends ChannelOrderActionImpl implements CategoryOrderAction {
    ...
    protected void validateInput(GuildChannel entity) {
        ...
        if (!(entity instanceof ICategorizableChannel categorizable)) {
            throw new IllegalArgumentException("Provided channel is not an ICategorizableChannel");
        }
        Checks.check(
                getCategory().equals(categorizable.getParentCategory()),

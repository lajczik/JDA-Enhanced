...
public class RestActionAssertions implements ThrowingConsumer<Request<?>> {
    ...
    @CheckReturnValue
    public static RestActionAssertions assertThatNextAction(
            SnapshotHandler snapshotHandler, Requester requester, RestAction<?> action) {
    ...
    public RestActionAssertions hasMethod(@Nonnull Method method) {
        return checkAssertions(request -> assertThat(request.getRoute().getMethod())
    ...
    public RestActionAssertions hasCompiledRoute(@Nonnull String route) {
        return checkAssertions(request -> assertThat(request.getRoute().getCompiledRoute())
    ...
    public RestActionAssertions hasAuditReason(@Nonnull String reason) {
        return checkAssertions(request -> assertThat(request.getHeaders())
    ...
    private DataObject getRequestBody(@Nonnull Request<?> request) {
        ...
        assertThat(body).isNotNull().isInstanceOf(DataObject.class);

...
class ChannelCacheViewTest {
        ...
        return switch (threadType) {
            case GUILD_PRIVATE_THREAD ->
                mockChannel(
                        ...
                        ChannelType.TEXT,
                        "TEXT parent of " + threadType,
                        GuildMessageChannel.class);
            case GUILD_NEWS_THREAD ->
                mockChannel(
                        IThreadContainerUnion.class,
                        ChannelType.NEWS,
                        "NEWS parent of " + threadType,
                        GuildMessageChannel.class);
    ...
    private static SortedChannelCacheViewImpl<GuildChannel> getMockedGuildCache() {
        ...
        for (ChannelType type : ChannelType.values()) {
            ...
            if (ICategorizableChannel.class.isAssignableFrom(channelType)) {
                ...
                when(parent.toString()).thenReturn(containerType + " parent of " + type);
    ...
    void testEmptyWorks() {
        ...
        assertThat(filled).as("Filled cache must not be empty").isNotEmpty();
        assertThat(filled.ofType(GuildMessageChannel.class))
